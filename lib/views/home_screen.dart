        ...
        children: [
                ...
                Container(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      suffixIcon: Obx(() => _productController.searchQuery.value.isNotEmpty
                          ? IconButton(
                              icon: const Icon(
                                Icons.clear,
                                color: AppColors.textSecondary,
          ...
          Expanded(
            child: Obx(() {
              ...
              print('Products count: ${_productController.filteredProducts.length}'); // Debug
